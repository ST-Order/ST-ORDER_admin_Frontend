        ...
        <div className="w-full px-6 py-4 bg-white rounded-[20px] justify-between items-center flex">
          <div className="flex items-center justify-center gap-11">
            ...
            <Link
              ...
              className="flex flex-col items-start gap-6 min-w-96"
            >
          ...
          <div className="flex items-center gap-3">
            <Link
              href={`/notice/${noticeItem.id}/edit`}
              className=" p-7 bg-blue2 rounded-2xl text-white text-2xl font-medium font-['Inter'] leading-7"
            >
              수정
            </Link>
